        ...
        <div className="grid gap-8 lg:grid-cols-[2fr_1fr_1fr_1fr]">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-2">
              <div className="relative h-12 w-12 overflow-hidden rounded-lg bg-gradient-to-br from-muted to-accent">
                <div className="absolute left-1/2 top-1/2 h-8 w-8 -translate-x-1/2 -translate-y-1/2">
                  ...
                  <div className="absolute left-1/2 top-1/2 h-6 w-6 -translate-x-1/2 -translate-y-1/2 rounded-sm bg-background"></div>
                </div>
              </div>
            </div>
            ...
            <p className="max-w-xs text-sm leading-relaxed text-muted-foreground">
              AI-powered tools for business growth, seamless scaling, and proven
              results.
            </p>
